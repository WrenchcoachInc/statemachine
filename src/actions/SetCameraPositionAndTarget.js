...
class SetCameraPositionAndTarget extends StateAction {
  ...
  constructor() {
    ...
    this.addParameter(
      new ZeaEngine.TreeItemParameter('Camera', treeItem => treeItem instanceof ZeaEngine.Camera)
    )
    this.addParameter(new ZeaEngine.Vec3Parameter('cameraPos'))
    this.addParameter(new ZeaEngine.Vec3Parameter('cameraTarget'))
    this.addParameter(new ZeaEngine.NumberParameter('interpTime', 1.0))
    this.addParameter(new ZeaEngine.NumberParameter('updateFrequency', 30))
  }
