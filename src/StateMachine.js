 ...
 * @extends BaseItem
 */
class StateMachine extends ZeaEngine.BaseItem {
  /**
  ...
  fromJSON(j, context, flags) {
    ...
    for (const key in j.states) {
      ...
      const state = ZeaEngine.sgFactory.constructClass(statejson.type)
      if (state) {
...
ZeaEngine.sgFactory.registerClass('StateMachine', StateMachine)
